...
class TradingPipeline:
    ...
    def run(self, ticker: str) -> dict:
        ...
        print(f"\n[1/3] Fetching market data for {ticker}...")
        ...
        print(f"\n[2/3] Fetching sentiment for {ticker}...")
        ...
        print(f"\n[3/3] Querying Strategy Agent (LLM)...")
        result = self.agent.decide(market_data, sentiment_data)
